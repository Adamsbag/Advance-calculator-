...
root=Tk()
root.title("secientific Calculator")
root.configure(background="powder blue")
root.geometry("473x490+0+0")
...
btn2pi=Button(calc,text="2π",width=6,height=2,font=('arial',20,'bold'),bd=4,
                ...
                bg="powder blue",command=added_value.tau1).grid(row=2,column=4,pady=1)  
...
btnmod=Button(calc,text="Mod",width=6,height=2,font=('arial',20,'bold'),bd=4,command=lambda:added_value.operation("mode")
...
btnexm1=Button(calc,text="expm1",width=6,height=2,font=('arial',20,'bold'),bd=4,

                bg="powder blue",command=added_value.exmp1).grid(row=5,column=6,pady=1)
btngamma=Button(calc,text="Lgamma",width=6,height=2,font=('arial',20,'bold'),bd=4,
...
btnEquals=Button(calc,text="=",width=6,height=2,font=('arial',20,'bold'),bd=4,
                ...
                bg="powder blue",command=added_value.sum_of_total).grid(row=5,column=3,pady=1) 
#================================================================================================
lablDisplay=Label(calc,text="Scientific calculator", font =('arial',30,"bold"),justify=CENTER)
lablDisplay.grid(row=0, column=4, columnspan=4)

#===========================================Menu function============================================
def iExit():
    iExit=tkinter.messagebox.askyesnlo("Scientific Calculator","Confirm if you want to exit")
    if iExit>0:
        root.destroy()
        return
